    ...
    OPEN(CORRGRACEbin,FILE=INPUT_DIRECTORY // 'EnKF_corrGRACE.bin',STATUS='old',RECL=NC,FORM='UNFORMATTED',ACCESS='DIRECT') !Input binary file with matrix of correlation among catchments

	DO K=1,NC
	    READ(CORRGRACEbin,REC=K)(CorrGRACE_EnKF(J,K),J=1,NC)
    ENDDO
