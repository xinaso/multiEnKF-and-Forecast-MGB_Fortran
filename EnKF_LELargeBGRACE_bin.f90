    ...
    OPEN(LargeBbin,FILE=INPUT_DIRECTORY // 'LargeBasinGRACECat.bin',STATUS='old',RECL=NC,FORM='UNFORMATTED',ACCESS='DIRECT') !Input binary file with matrix of correlation among catchments

	DO K=1,NGC
	    READ(LargeBbin,REC=K)(LargeB_GRACE(J,K),J=1,NC)
    ENDDO
