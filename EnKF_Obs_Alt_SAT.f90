 !---------------------------------------------------------------------------------
    ...
    !  Discussion:
    ! 
    !   This sub-routine reads the altimetry observations and calculates the number of observations
    !
    !
    !---------------------------------------------------------------------------------
    ...
    ! EnKF_Obs_AltimetryAnom_SAT.alt - Record of altimetry
    !---------------------------------------------------------------------------------
    ! End of header
    !---------------------------------------------------------------------------------
    subroutine EnKF_Obs_Alt_SAT
	!------------------------------------------------------------------------------
	!-----------------------------------------------------------------------------
    ...
    read(55586,*) i,j,k,(Obs_ASAT(iObs),iObs=1,nObs_ASAT)
	...
	end subroutine EnKF_Obs_Alt_SAT