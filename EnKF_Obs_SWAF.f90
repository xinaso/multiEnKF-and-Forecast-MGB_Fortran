 !---------------------------------------------------------------------------------
    ...
    !  Discussion:
    ! 
    !   This sub-routine reads the SWAF flooded water extension observations and calculates the number of observations
    !
    !
    !---------------------------------------------------------------------------------
    ...
    ! EnKF_Obs_AreaSWAF.are - Record of SWAF flooded water extension
    !---------------------------------------------------------------------------------
    ! End of header
    !---------------------------------------------------------------------------------
    subroutine EnKF_Obs_SWAF
    
	! Subrotina para contar as observacoes a serem assimiladas.
	! Sly Wongchuig jan/2018
    ...
    ! Inicialmente preparada somente para vazoes:

    read(5558,*) i,j,k,(Obs_SWAF(iObs),iObs=1,nObs_SWAF)
