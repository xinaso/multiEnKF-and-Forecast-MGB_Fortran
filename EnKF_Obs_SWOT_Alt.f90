 !---------------------------------------------------------------------------------
    ...
    !  Discussion:
    ! 
    !   This sub-routine reads the SWOT altimetry observations and calculates the number of observations
    !
    !
    !---------------------------------------------------------------------------------
    ...
    ! EnKF_Y_Obs_SWOT.alt - Record of SWOT altimetry
    !---------------------------------------------------------------------------------
    ! End of header
    !---------------------------------------------------------------------------------
    subroutine EnKF_Obs_SWOT_Alt
	!------------------------------------------------------------------------------
	!-----------------------------------------------------------------------------
    ...
    read(55582,*) i,j,k,(Obs_SWOT_Alt(iObs),iObs=1,nObs_SWOT)
	...
	end subroutine EnKF_Obs_SWOT_Alt