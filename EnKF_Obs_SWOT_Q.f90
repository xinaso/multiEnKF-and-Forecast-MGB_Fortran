 !---------------------------------------------------------------------------------
    ...
    !  Discussion:
    ! 
    !   This sub-routine reads the SWOT discharge observations and calculates the number of observations
    !
    !
    !---------------------------------------------------------------------------------
    ...
    ! EnKF_Q_Obs_SWOT.vaz - Record of SWOT discharge
    !---------------------------------------------------------------------------------
    ! End of header
    !---------------------------------------------------------------------------------
    subroutine EnKF_Obs_SWOT_Q
	!------------------------------------------------------------------------------
	!-----------------------------------------------------------------------------
    ...
    read(55585,*) i,j,k,(Obs_SWOT_Q(iObs),iObs=1,nObs_SWOT)
	...
	end subroutine EnKF_Obs_SWOT_Q