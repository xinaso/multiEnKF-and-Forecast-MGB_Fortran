...
call sample2D(A2,nlon,nlat,nrens,nre,rhVars(2),samp_fix)
...
if (iT==1) ro=0.0
noiseVars(:,iEns,2)=ro*noiseVars(:,iEns,2)+(1.-ro**2)**0.5*noise1
if (iEns==1) write(666166622,*) ro,noiseVars(50,iEns,2),noiseVars(500,iEns,2),noiseVars(676,iEns,2)
noise1=noiseVars(:,iEns,2)

! Aplica equacao 2 de Nijssen e Lettenmaier (2004)
noise1=(log(ErroVBAS**2+1.))**0.5*noise1
noise1=exp(noise1)
noise1=(1.+BIAS)*noise1/(ErroVBAS**2+1.)**0.5
VBAS=VBAS*noise1
if (iEns==1) write(666166632,*) ro,noise1(50),noise1(500),noise1(676)
