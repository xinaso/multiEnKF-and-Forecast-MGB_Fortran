   !---------------------------------------------------------------------------------
    ...
    !  Discussion:
    ! 
    !   This sub-routine is used to perturb the VINT state variable
    !
    !
    !---------------------------------------------------------------------------------
...
call sample2D(A2,nlon,nlat,nrens,nre,rhVars(3),samp_fix)
...
if (iT==1) ro=0.0
noiseVars(:,iEns,3)=ro*noiseVars(:,iEns,3)+(1.-ro**2)**0.5*noise1
if (iEns==1) write(666166623,*) ro,noiseVars(50,iEns,3),noiseVars(500,iEns,3),noiseVars(676,iEns,3)
noise1=noiseVars(:,iEns,3)


! Aplica equacao 2 de Nijssen e Lettenmaier (2004)
noise1=(log(ErroVINT**2+1.))**0.5*noise1
noise1=exp(noise1)
noise1=(1.+BIAS)*noise1/(ErroVINT**2+1.)**0.5
VINT=VINT*noise1
if (iEns==1) write(666166633,*) ro,noise1(50),noise1(500),noise1(676)
