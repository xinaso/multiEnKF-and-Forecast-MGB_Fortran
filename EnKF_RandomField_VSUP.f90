   !---------------------------------------------------------------------------------
    ...
    !  Discussion:
    ! 
    !   This sub-routine is used to perturb the VSUP state variable
    !
    !
    !---------------------------------------------------------------------------------
...
call sample2D(A2,nlon,nlat,nrens,nre,rhVars(4),samp_fix)
...
if (iT==1) ro=0.0
noiseVars(:,iEns,4)=ro*noiseVars(:,iEns,4)+(1.-ro**2)**0.5*noise1

if (iEns==1) write(666166624,*) ro,noiseVars(50,iEns,4),noiseVars(500,iEns,4),noiseVars(676,iEns,4)
noise1=noiseVars(:,iEns,4)


! Aplica equacao 2 de Nijssen e Lettenmaier (2004)
noise1=(log(ErroVSUP**2+1.))**0.5*noise1
noise1=exp(noise1)
noise1=(1.+BIAS)*noise1/(ErroVSUP**2+1.)**0.5
VSUP=VSUP*noise1

if (iEns==1) write(666166634,*) ro,noise1(50),noise1(500),noise1(676)
