    ...
    !  Discussion:
    ! 
    !   This sub-routine updates the state variables of the model by using the EnKF equations.
    !
    !
    !---------------------------------------------------------------------------------
    ...
    ! End of header
    !---------------------------------------------------------------------------------
    subroutine analysis_new(A, R, E, S, D, innov, ndim, nrens, nrobs, verbose, truncation,mode,update_randrot)
